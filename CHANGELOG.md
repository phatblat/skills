...
- the changelog records the `1.0.0` and `1.0.1` releases that shipped, instead of a `0.1.0` section that was never released.
...
[Unreleased]: https://github.com/phatblat/skills/compare/v1.0.3...HEAD
[1.0.3]: https://github.com/phatblat/skills/compare/v1.0.2...v1.0.3
